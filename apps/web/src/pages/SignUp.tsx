...
function SignUp() {
  ...
  return (
    <AuthLayout
      ...
      artSrc="/ART/artisan-tools.jpg"
      footer={
        <p className="text-[13px]">
          <span className="text-white/30">Already have an account?</span>{" "}
          <Link to="/login" className="text-[#D4AF37]/80 hover:text-[#D4AF37] font-semibold transition-colors">
            Sign in
          </Link>
        </p>
      }
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="auth-stagger" style={{ "--i": 5 } as React.CSSProperties}>
          ...
          {password.length > 0 && password.length < 8 && (
            <p className="text-xs text-[#D4AF37]/70 mt-1.5">
