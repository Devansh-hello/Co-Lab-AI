        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
            ...
            <div className="cta-item flex flex-wrap gap-2.5 flex-shrink-0" style={{ opacity: 0 }}>
              <Link
                to="/projects"
                className="group inline-flex items-center justify-center gap-2 h-10 px-6 rounded-lg bg-[#D4AF37] hover:bg-[#E0C050] text-black font-bold text-[13px] transition-all glow-gold hover:glow-gold-strong relative overflow-hidden shine-gold"
              >
                Start Building
              ...
              <Link
                to="/signup"
                className="inline-flex items-center justify-center gap-2 h-10 px-6 rounded-lg border border-white/[0.1] text-white/60 hover:text-white hover:border-white/20 hover:bg-white/[0.04] font-semibold text-[13px] transition-all"
              >
                Create Account
              </Link>
              <Link
                to="/benchmarks"
                className="inline-flex items-center justify-center gap-2 h-10 px-5 text-white/55 hover:text-white/70 font-medium text-[13px] transition-colors"
              >
                View Benchmarks →
              </Link>
            </div>
          ...
          <div className="cta-item flex items-center gap-5 text-[9px] font-mono text-white/25 uppercase tracking-[0.12em]" style={{ opacity: 0 }}>
            ...
            <span className="w-px h-2.5 bg-white/10" />
            <span><span className="text-[#D4AF37] text-[12px] font-bold tabular-nums">A</span> Quality</span>
          </div>
        </div>
      </div>
    </section>
