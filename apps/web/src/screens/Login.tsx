...
function Login() {
  ...
  const { refresh, user, isInitialized } = useAuth()
  ...
  return (
    <AuthLayout
      ...
      artSrc="/ART/golden-door.webp"
      footer={
        <p className="text-[13px]">
          <span className="text-white/30">Don't have an account?</span>{" "}
          <Link href="/signup" className="text-gold-500/80 hover:text-gold-500 font-semibold transition-colors">
            Create one
          </Link>
        </p>
      }
