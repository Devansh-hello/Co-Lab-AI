    ...
    <div className="flex flex-col min-h-screen bg-background bg-grainy">
      ...
      <main ref={pageRef} className="flex-1 w-full pt-20">
        ...
        <section className="py-16 md:py-24 px-4 md:px-8 text-center">
          <p className="text-[11px] font-mono text-gold-500/60 mb-3 tracking-[0.15em] uppercase font-bold">Benchmarks & Research</p>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {SPEED_GAINS.map((s, i) => (
                <div key={i} className="bench-item rounded-xl border border-white/[0.06] bg-white/[0.02] p-5 text-center" style={{ opacity: 0 }}>
                  <div className="text-3xl font-black text-gold-500 mb-1">{s.factor}</div>
        ...
        <section className="bench-section py-12 md:py-20 px-4 md:px-8 border-t border-white/[0.04]">
          <div className="container mx-auto max-w-5xl">
            ...
            <div className="space-y-2">
              {PAPERS.map((p, i) => (
                <div key={i} className="bench-item flex items-start gap-3 py-3 px-4 rounded-lg hover:bg-white/[0.02] transition-colors duration-150 group" style={{ opacity: 0 }}>
                  ...
                  {p.id && (
                    <a
                      ...
                      className="text-[10px] text-white/20 hover:text-blue-400 transition-colors duration-150 flex items-center gap-1 flex-shrink-0 mt-0.5"
                    >
